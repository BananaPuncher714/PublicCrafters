...
public class ContainerManager_v1_20_R3 implements CraftInventoryManager {
	...
	public ContainerManager_v1_20_R3() {
		MinecraftServer server = MinecraftServer.getServer();
		WorldServer world = server.F();
		...
		}, mockPlayer, new CommonListenerCookie( profile, 1, ClientInformation.a() ) ) {
			@Override
