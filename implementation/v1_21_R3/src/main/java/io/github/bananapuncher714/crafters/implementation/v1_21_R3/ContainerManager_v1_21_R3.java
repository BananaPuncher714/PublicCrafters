package io.github.bananapuncher714.crafters.implementation.v1_21_R3;
...
import io.github.bananapuncher714.crafters.implementation.v1_21_R3.ContainerManager_v1_21_R3.SelfContainer;
...
public class ContainerManager_v1_21_R3 implements CraftInventoryManager {
	...
	public ContainerManager_v1_21_R3() {
		MinecraftServer server = MinecraftServer.getServer();
		WorldServer world = server.J();
		GameProfile profile = new GameProfile( new UUID( 0, 0 ), "" );
		mockPlayer = new EntityPlayer( server, world, profile, ClientInformation.a() );
		
		mockPlayer.f = new PlayerConnection( server, new NetworkManager( EnumProtocolDirection.a ) {
		    @Override
	...
	protected static class SelfContainer extends Container {
        ...
        public boolean b( EntityHuman entity ) {
            return container == null ? false : container.b( entity );
        }

        @Override
        public net.minecraft.world.item.ItemStack b( EntityHuman arg0, int arg1 ) {
