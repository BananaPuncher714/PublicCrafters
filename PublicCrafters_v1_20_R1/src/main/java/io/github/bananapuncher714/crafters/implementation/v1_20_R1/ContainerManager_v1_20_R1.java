...
public class ContainerManager_v1_20_R1 implements CraftInventoryManager {
	...
	public ContainerManager_v1_20_R1() {
		MinecraftServer server = MinecraftServer.getServer();
		WorldServer world = server.D();
		mockPlayer = new EntityPlayer( server, world, new GameProfile( new UUID( 0, 0 ), "" ) );
		
		mockPlayer.c = new PlayerConnection( server, new NetworkManager( EnumProtocolDirection.b ), mockPlayer ) {
			@Override
