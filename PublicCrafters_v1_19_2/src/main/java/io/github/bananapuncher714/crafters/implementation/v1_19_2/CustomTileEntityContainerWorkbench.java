...
public class CustomTileEntityContainerWorkbench implements ITileEntityContainer {
	...
	public CustomTileEntityContainerWorkbench(ContainerManager_v1_19_2 manager, Location blockLoc ) {
	...
	public Container createMenu( int id, PlayerInventory inv, EntityHuman ent ) {	
		...
		if ( crafting == null ) {
			crafting = new CustomInventoryCrafting( bloc, manager, new ContainerManager_v1_19_2.SelfContainer( id ), 3, 3 );
